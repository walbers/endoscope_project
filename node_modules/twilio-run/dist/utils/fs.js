...
exports.getDirContent = exports.downloadFile = exports.fileExists = exports.mkdir = exports.readdir = exports.writeFile = exports.readFile = void 0;
...
function fileExists(filePath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield access(filePath, fs_1.default.constants.R_OK | fs_1.default.constants.W_OK);
            return true;
        }
        catch (err) {
            return false;
...
function downloadFile(contentUrl, targetPath) {
    return new Promise((resolve, reject) => {
        return exports.mkdir(path_1.default.dirname(targetPath), { recursive: true })
