...
const debug = logger_1.getDebugFunction('twilio-run:new:template-data');
const TEMPLATE_BASE_REPO = process.env.TWILIO_SERVERLESS_TEMPLATE_REPO ||
    'twilio-labs/function-templates';
const TEMPLATE_BASE_BRANCH = process.env.TWILIO_SERVERLESS_TEMPLATE_BRANCH || 'master';
...
function fetchListOfTemplates() {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield got_1.default(exports.TEMPLATES_URL, { json: true });
...
function getNestedRepoContents(url, dirName, directory) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return lodash_flatten_1.default(yield Promise.all(repoContents.map((file) => __awaiter(this, void 0, void 0, function* () {
            if (file.type === 'dir') {
...
function getTemplateFiles(templateId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const headers = buildHeader();
            const response = yield got_1.default(exports.CONTENT_BASE_URL + `/${templateId}?ref=${TEMPLATE_BASE_BRANCH}`, {
                json: true,
                headers,
            });
            const repoContents = response.body;
