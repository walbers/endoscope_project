...
function getConfigFromFlags(flags, externalCliOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { localEnv: envVariables } = yield utils_2.readLocalEnvFile(flags);
        const { accountSid, authToken } = yield utils_2.getCredentialsFromFlags(flags, envVariables, externalCliOptions);
        const env = utils_2.filterEnvVariablesForDeploy(envVariables);
